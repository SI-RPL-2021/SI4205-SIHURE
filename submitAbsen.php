    ...
    <body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="HomeKaryawan.php">Logout</a>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <h3 style="text-align:center;color:black;font-weight:bolder;">ABSENSI</h1>
                    <div class="d-flex justify-content-center" style="margin-top: 10px">
                        <form action="create.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col">

                                    <div style="width: 400px; height: 200px" class="card text-center">
                                        <div class="card-header">
                                            Thank you! Your absence has been
                                            submitted.
                                        </div>
                                        <div style="background-color:#B0C4DE" class="card-body">
                                            <a style="background-color:#042331 " href="Absen.php" class="btn btn-primary">Close</a>
                                        </div>
