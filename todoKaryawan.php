        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div class="d-flex justify-content-center" style="margin-top: 10px">
                    ...
                    <form action="belajar.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col">


                                <div style="width: 500px; height: 400px" class="card text-center">
                                    ...
                                    <div style="background-color:#B0C4DE" class="card-body">
                                        ...
                                        <button type="submit" name="submit1" style="background-color:#042331 " class="btn btn-primary">Submit</button>
                                    </div>
